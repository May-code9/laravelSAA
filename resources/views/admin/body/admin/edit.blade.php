...
<div class="page-content">
	...
	<div class="row">
		<div class="col-md-12 stretch-card">
			<div class="card">
				<div class="card-body">
					<h6 class="card-title">Admin | Edit Admin</h6>
					...
					@endif
					<form action="/edit/admin/{{ $getAdmin->user_id }}" method="POST">
						@csrf
						<div class="row">
							<div class="col-sm-6">
								<div class="form-group">
									...
									<select class="form-control" name="user_id" required>
										<option selected value="{{ $getAdmin->user_id }}"> {{ $getAdmin->id }}. {{ $getAdmin->first_name }} {{ $getAdmin->last_name }}</option>
							...
							<div class="col-sm-6">
								<div class="form-group">
									...
									<select class="form-control" name="slug" required>
										<option selected value="{{ $getAdmin->slug }}">{{ $getAdmin->role }}</option>
										<option disabled>-- Select --</option>
